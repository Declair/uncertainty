...
class ShowNotebook(aui.AuiNotebook):
    ...
    def TestPanel(self, pProj = 0):
        ...
        # self.text_ctrl_db = wx.TextCtrl(show_panel, value='...', style=wx.TE_READONLY)
        ...
        self.static_text_5a = wx.StaticText(show_panel, -1, label="训练输入个数：")
    ...
    #         self.text_ctrl_db.SetLabel(str(self.conn.connection_id))
    #     except Error as e:
    #         print(e)
    #     finally:
    #         print '导入数据'
